...
const snapshotSchema = z.object({
  ...
  category: z.string().optional().default("strength"),
  mechanic: z.string().nullable().optional().default(null),
});
...
const backupDataSchema = z.object({
  app: z.enum(["treino-de-hoje", "gymsheet"]),
  exportedAt: z.string(),
  data: appStateSchema,
});
...
const backupV3Schema = backupDataSchema.extend({ schemaVersion: z.literal(3) });

export const backupSchema = z.union([backupV1Schema, backupV2Schema, backupV3Schema]);
